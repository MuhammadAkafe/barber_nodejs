...
module.exports.up=function (knex) {
      return knex.raw(`
        CREATE FUNCTION add_appointment(
        _userid int,
      ...
      BEGIN
        ...
        IF EXISTS (SELECT 1 FROM appointments WHERE slot_date = _slot_date) THEN
        ...
        IF EXISTS (
          SELECT 1 
          FROM appointments 
          WHERE ABS(EXTRACT(EPOCH FROM (slot_date - _slot_date))) / 60 < 15
        ) THEN
